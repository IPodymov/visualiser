...
Use the project skills in `.agents/skills` for frontend product work:
...
Before adding a component, search `apps/frontend/src/components` for an existing primitive or domain equivalent. Preserve the React/Vite + TypeScript frontend, Express/Prisma backend, and current DTOs unless a targeted contract change is necessary for the user journey.
