...
import { PageHeader, PageSection, SectionHeader } from '@shared/ui/PageLayout/PageLayout';
...
export const ProfilePage = () => {
  ...
  const setFavorites = useWorkspaceStore((state) => state.setFavorites);
  const favoriteIds = useWorkspaceStore((state) => state.favorites);
