...
export const TabsContent = ({
  ...
  <TabsPrimitive.Content
    className={cn('motion-tab-panel mt-4 focus-visible:outline-none', className)}
    {...props}
  />
);
